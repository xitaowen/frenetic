...
(* OASIS_START *)
(* DO NOT EDIT (digest: e45ff8a7f5535fe55072b61e8d8fd340) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "maclearning.ml"; });
               Executable
                 ({
                     cs_name = "netkat_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "d\157t\180T\175\024\031wU\200\165\1987J\170";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
